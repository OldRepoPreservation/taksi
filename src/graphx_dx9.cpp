...
static HRESULT InvalidateDeviceObjects(IDirect3DDevice9* dev);
...
//-----------------------------------------------------------------------------
HRESULT InvalidateDeviceObjects(IDirect3DDevice9* dev)
{
	TRACE("InvalidateDeviceObjects: called.");

    // Try to delete the state blocks
	try
    {
