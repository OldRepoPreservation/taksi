...
#define TAKSI_VERSION_N			0x0759
#ifdef _DEBUG
#define TAKSI_VERSION_S			"0.759 (Debug)"
#else
#define TAKSI_VERSION_S			"0.759"
#endif
// for VS_VERSION_INFO VERSIONINFO 
#define TAKSI_VERSION_RES_N		0,7,5,9
#define TAKSI_VERSION_RES_S		"0,7,5,9"
