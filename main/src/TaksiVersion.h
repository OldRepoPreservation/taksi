...
#define TAKSI_VERSION_N			0x0747
#ifdef _DEBUG
#define TAKSI_VERSION_S			"0.747 (Debug)"
#else
#define TAKSI_VERSION_S			"0.747"
#endif
// for VS_VERSION_INFO VERSIONINFO 
#define TAKSI_VERSION_RES_N		0,7,4,7
#define TAKSI_VERSION_RES_S		"0,7,4,7"
