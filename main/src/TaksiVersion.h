...
#define TAKSI_VERSION_N			0x0755
#ifdef _DEBUG
#define TAKSI_VERSION_S			"0.755 (Debug)"
#else
#define TAKSI_VERSION_S			"0.755"
#endif
// for VS_VERSION_INFO VERSIONINFO 
#define TAKSI_VERSION_RES_N		0,7,5,5
#define TAKSI_VERSION_RES_S		"0,7,5,5"
