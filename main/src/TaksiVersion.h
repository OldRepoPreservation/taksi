...
#define TAKSI_VERSION_N			0x0756
#ifdef _DEBUG
#define TAKSI_VERSION_S			"0.756 (Debug)"
#else
#define TAKSI_VERSION_S			"0.756"
#endif
// for VS_VERSION_INFO VERSIONINFO 
#define TAKSI_VERSION_RES_N		0,7,5,6
#define TAKSI_VERSION_RES_S		"0,7,5,6"
