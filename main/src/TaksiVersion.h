...
#define TAKSI_VERSION_N			0x0754
#ifdef _DEBUG
#define TAKSI_VERSION_S			"0.754 (Debug)"
#else
#define TAKSI_VERSION_S			"0.754"
#endif
// for VS_VERSION_INFO VERSIONINFO 
#define TAKSI_VERSION_RES_N		0,7,5,4
#define TAKSI_VERSION_RES_S		"0,7,5,4"
