...
#define TAKSI_VERSION_N			0x0770
#ifdef _DEBUG
#define TAKSI_VERSION_S			"0.770 (Debug)"
#else
#define TAKSI_VERSION_S			"0.770"
#endif
// for VS_VERSION_INFO VERSIONINFO 
#define TAKSI_VERSION_RES_N		0,7,7,0
#define TAKSI_VERSION_RES_S		"0,7,7,0"
